...
const Page = () => {
    ...
    useEffect(() => {
        ...
        const fetchQuestion = async () => {
            try {
                ...
                fetchedQuestion.driverCode.forEach((dc: any) => {
                    if (dc.language === lang) {
                        setCode(dc.code)
                        setId(dc.id)
                    };
    ...
    const handleEditDriverCode = async () => {
        const response = await axios.post("/api/admin/editQuestion/driverCode", {
            id: id,
            code: code
        })
    ...
    return (
        <div className="min-h-screen bg-black text-white">
            ...
            <main className="flex flex-col px-6 py-8 space-y-8">
                <h1 className="text-4xl font-extrabold tracking-wide">Edit {lang} Driver Code</h1>
